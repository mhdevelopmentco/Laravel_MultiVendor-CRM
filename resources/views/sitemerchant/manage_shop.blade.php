...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Manage Merchant Accounts         </title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#"> Manage Store Accounts          </a></li>
                            </ul>
                    </div>
                </div>
                                  ...
                                  <?php $i = 1;
								     ...
								     foreach($store_return as $store_details){ ?>
										<tr class="gradeA odd">
                                            ...
                                            <td class="text-center"><a href="<?php echo url('merchant_edit_shop/'.$store_details->stor_id."/".$store_details->stor_merchant_id); ?>"><i class="icon icon-edit icon-2x"></i></a></td>                                            
                                            <td class="text-center ">
                                            
                                            <?php if($store_details->stor_status == 1) { ?>
                                            <a href="<?php echo url('merchant_block_shop/'.$store_details->stor_id."/0"."/".$store_details->stor_merchant_id); ?>"><i class="icon icon-ok icon-2x "></i></a> <?php } else if($store_details->stor_status == 0) { ?>
                                            <a href="<?php echo url('merchant_block_shop/'.$store_details->stor_id."/1"."/".$store_details->stor_merchant_id); ?>"><i class="icon icon-ban-circle icon-2x icon-me"></i></a> 
                                            <?php }  ?>
                                            </td>
