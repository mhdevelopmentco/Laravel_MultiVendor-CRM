...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Manage Auction</title>
        ...
        <div id="div-1" class="accordion-body collapse in body">
           ...
           <table aria-describedby="dataTables-example_info" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example">
                                    ...
                                    <tbody>
									  ...
									  {
										  $process = "<a href='".url('merchant_block_auction/'.$auction_list->auc_id.'/0/'.$merchantid)."' > <i style='margin-left:10px;' class='icon icon-ok icon-me'></i> </a>";
								  } else if($auction_list->auc_status == 0) {
										   $process = "<a href='".url('merchant_block_auction/'.$auction_list->auc_id.'/1/'.$merchantid)."' > <i style='margin-left:10px;' class='icon icon-ban-circle icon-me'></i> </a>";
									  }
									  ?>
                                    <tr class="gradeA odd">
                                            ...
                                            <td class="center  "><a href="#"><img style="height:40px;" src="<?php echo url(''); ?>/assets/auction/<?php echo $auc_get_img[0]; ?>"></a></td>
                                           
                                            <td class="center  ">
                                           <a href="<?php echo url('merchant_edit_auction/'.$auction_list->auc_id); ?>" > <i class="icon icon-edit" style="margin-left:15px;"></i></a>
                                         	<?php echo  $process; ?>
                                            </td>
                                            <td class="center  "><?php if($auction_list->auc_status == 1)
									  { ?><a href="<?php echo url('auctionview')."/".$auction_list->auc_id; ?>" target="_blank" ><i class="icon-search icon-2x"></i></a><?php } else { echo 'Unblock product'; } ?></td>
                                            <td class="center  "><a href="<?php echo url('merchant_auction_details')."/".$auction_list->auc_id; ?>">View details</a></td>
                                        </tr>
									<?php $i++; } ?>
