...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Deals COD All Orders</title>
...
{!!$merchantleftmenus!!}
        ...
        <div id="content">
                ...
                <div class="inner">
					...
					<center>
		 <form  action="{!!action('MerchantTransactionController@dealscod_all_orders')!!}" method="POST">
...
<div class="col-lg-12">
 ...
 if(isset($_POST['submit']))
			{
			foreach($allcod_reports as $allorders_list) {
