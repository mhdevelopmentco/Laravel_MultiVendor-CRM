                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Edit Merchant Account</a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
...
@if (Session::has('result'))
		<div class="alert alert-warning alert-dismissable">{!! Session::get('result') !!}
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button></div>
		@endif
        ...
        <div class="row">
        	<div class="col-lg-11 panel_marg"style="padding-bottom:10px;">
                    ...
                    {!! Form::open(array('url'=>'edit_merchant_account_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
