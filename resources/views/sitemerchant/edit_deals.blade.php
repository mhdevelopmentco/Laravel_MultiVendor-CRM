...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin | Add Deals</title>
...
foreach($deal_list as $deals)
		...
		?>
         {!! Form::open(array('url'=>'mer_edit_deals_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
				  ...
				  <input id="merchant" name="merchant"  class="form-control" value="{!! Session::get('merchantid')!!}" type="hidden">
				  <div class="form-group">
               ...
               <option value="0">-- Select --</option>
				 ...
				 <div class="form-group">
                    ...
                    <div class="col-lg-8" id="img_upload">
                       ...
                       <input type="file"  id="file" name="file" ><span><img src="<?php echo url(''); ?>/assets/deals/<?php echo $file_get_path[0]; ?>" height="50" width="50" > </span>                        </div>                   
                     <?php 
                     ...
                     <input type='file' name='file_more<?php echo $j; ?>' style="padding-bottom:5px;" /> <img src="<?php echo url(''); ?>/assets/deals/<?php echo $file_get_path[$j+1]; ?>" height="50" width="50" ></div>
					 <?php } ?>
                       <div id="divTxt"></div>  
