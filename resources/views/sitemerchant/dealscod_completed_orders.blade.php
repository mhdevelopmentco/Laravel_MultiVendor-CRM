...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Deals COD Completed Orders</title>
...
{!!$merchantleftmenus!!}
        ...
        <div id="content">
				...
				<center>
		 <form  action="{!!action('MerchantTransactionController@dealscod_completed_orders')!!}" method="POST">
...
if(isset($_POST['submit']))
	...
	foreach($allcodcompleted_reports as $allorders_list) {
