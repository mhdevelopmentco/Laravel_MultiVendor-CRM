...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Deals COD Hold Orders</title>
...
{!!$merchantleftmenus!!}
        ...
        <div id="content">
				...
				<center>
		 <form  action="{!!action('MerchantTransactionController@dealscod_hold_orders')!!}" method="POST">
...
if(isset($_POST['submit']))
			{
				foreach($allcodhold_reports as $allorders_list) {
					$orderstatus="Hold";
					$ordertype="";
