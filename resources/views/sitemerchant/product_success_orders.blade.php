...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Products Success Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Products Success Orders</a></li>
                            </ul>
                    </div>
                </div>
				<center>
		 <form  action="{!!action('MerchantTransactionController@product_success_orders')!!}" method="POST">
...
<div class="col-lg-12">
 ...
 if(isset($_POST['submit']))
			{
foreach($allsucessprod_reports as $allorders_list) {
