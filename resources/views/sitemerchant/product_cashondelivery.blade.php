...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin | Cash On Delivery </title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">  Cash On Delivery                   </a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
            ...
            <form class="form-horizontal">
				  <div class="form-group">
					...
					<input type="text" class="form-control" placeholder="" id="text1">Name,Email,Coupon Code
					  ...
					  <div class="col-lg-4"><button class="btn btn-warning btn-sm btn-grad"><a href="#" style="color:#fff">Search</a></button></div>
                    </div>
                </div>
				 <div class="form-group">
