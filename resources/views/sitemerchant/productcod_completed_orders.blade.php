...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |COD Completed Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">COD Completed Orders</a></li>
                            </ul>
                    </div>
                </div>
				<center>
		 <form  action="{!!action('MerchantTransactionController@cod_completed_orders')!!}" method="POST">
...
<th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 69px;" aria-label="S.No: activate to sort column ascending" aria-sort="ascending">S.No</th>
 ...
 if(isset($_POST['submit']))
			...
			foreach($allpro_codcompleted_reports as $allorders_list) {
