...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <?php if(isset($action) && $action == 'save') { $process = 'save'; $button = 'Add Deals'; $form_action = 'add_deals_submit'; } 
         ...
         {!! Form::open(array('url'=>'mer_add_deals_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
                ...
                <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input id="discountprice" name="discountprice" placeholder="Numbers Only" class="form-control" type="text">
                    </div>
                </div>
				  <div class="form-group">
                ...
                <input id="merchant" name="merchant"  class="form-control" value="{!! Session::get('merchantid')!!}" type="hidden">
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input id="minlimit" name="minlimt" placeholder="Numbers Only" class="form-control" type="text">
                    </div>
                </div>
				  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input id="maxlimit" name="maxlimit" placeholder="Numbers Only" class="form-control" type="text">
                    </div>
                </div>
