...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Products Failed Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Products Failed Orders</a></li>
                            </ul>
                    </div>
                </div>
				
				<center>
		 <form  action="{!!action('MerchantTransactionController@product_failed_orders')!!}" method="POST">
...
<div class="col-lg-12">
 ...
 if(isset($_POST['submit']))
			{
				foreach($getproduct_failed_orders as $allorders_list) {
