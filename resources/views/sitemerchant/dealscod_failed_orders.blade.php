...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Deals COD Failed Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Deals COD Failed Orders</a></li>
                            </ul>
                    </div>
                </div>
				
				<center>
		 <form  action="{!!action('MerchantTransactionController@dealscod_failed_orders')!!}" method="POST">
...
foreach($allcodfailed_reports as $allorders_list) {
