...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Deals Completed Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Deals Completed Orders</a></li>
                            </ul>
                    </div>
                </div>
				
				<center>
		 <form  action="{!!action('MerchantTransactionController@deals_completed_orders')!!}" method="POST">
 ...
 if(isset($_POST['submit']))
			{
						...
						foreach($getcomp_dealreports as $allorders_list) {
