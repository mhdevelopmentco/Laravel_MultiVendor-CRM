...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |COD Failed Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">COD Failed Orders</a></li>
                            </ul>
                    </div>
                </div>
				
				<center>
		 <form  action="{!!action('MerchantTransactionController@cod_failed_orders')!!}" method="POST">
...
if(isset($_POST['submit']))
			{
				foreach($allprod_failedreports as $allorders_list) {
