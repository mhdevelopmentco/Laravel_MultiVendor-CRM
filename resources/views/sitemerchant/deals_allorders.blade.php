...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Deals All Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Deals All Orders</a></li>
                            </ul>
                    </div>
                </div>
				
				<center>
		 <form  action="{!!action('MerchantTransactionController@deals_all_orders')!!}" method="POST">
        ...
        <div id="div-1" class="accordion-body collapse in body">
           ...
           <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="dataTables-example_length"><label>
			...
			if(isset($_POST['submit']))
			{
				...
				foreach($dealrepp as $allorders_list) {
