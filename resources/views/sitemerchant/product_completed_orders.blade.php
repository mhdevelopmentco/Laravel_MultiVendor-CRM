...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Products Completed Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Products Completed Orders</a></li>
                            </ul>
                    </div>
                </div>
				<center>
		 <form  action="{!!action('MerchantTransactionController@product_completed_orders')!!}" method="POST">
...
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>Products Completed Orders</h5>
		...
		if(isset($_POST['submit']))
			{
				foreach($allcompletedprod_reports as $allorders_list) {
