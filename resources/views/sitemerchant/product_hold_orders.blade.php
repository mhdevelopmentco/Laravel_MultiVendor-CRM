                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Products Hold Orders</a></li>
                            </ul>
                    </div>
                </div>
				<center>
		 <form  action="{!!action('MerchantTransactionController@product_hold_orders')!!}" method="POST">
...
<div class="col-lg-12">
 ...
 if(isset($_POST['submit']))
	...
	foreach($allholdprod_reports as $allorders_list) {
