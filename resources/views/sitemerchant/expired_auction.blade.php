...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Archive Auction</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Archive Auction</a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
        ...
        <div id="div-1" class="accordion-body collapse in body">
           ...
           <table aria-describedby="dataTables-example_info" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example">
                                    <thead>
										...
										<th aria-label="CSS grade: activate to sort column ascending" style="width: 100px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">Bid Increment($)</th>
										...
										<th aria-label="CSS grade: activate to sort column ascending" style="width: 100px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">Auction details</th>
                                    ...
                                    <tr class="gradeA odd">
                                            ...
                                            <td class="center  "><?php echo $auction_list->auc_bitinc; ?></td>
                                            <td class="center  "><a href="#"><img style="height:40px;" src="<?php echo url(''); ?>/assets/auction/<?php echo $auc_get_img[0]; ?>"></a></td>
                                     
                                           
                                            <td class="center  "><a href="#"><i class="icon-search icon-2x"></i></a></td>
