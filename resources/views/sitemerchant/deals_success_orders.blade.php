...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Deals Success Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Deals Success Orders</a></li>
                            </ul>
                    </div>
                </div>
				<center>
		 <form  action="{!!action('MerchantTransactionController@deals_success_orders')!!}" method="POST">
...
<div class="col-lg-12">
 ...
 if(isset($_POST['submit']))
			{
				foreach($getsuccess_dealreports as $allorders_list) {
