...
foreach($auction_list as $auction)
		...
		?>
         {!! Form::open(array('url'=>'merchant_edit_auction_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                       <select class="form-control" id="shop" name="shop"> $shop	
              <option value="0">Choose a Shop Name</option>
  	@foreach($shopdetails as $shop_det)
		
           <option value="{!! $shop_det->stor_id!!}" <?php if($shop_det->stor_id==  $shop) { ?> selected <?php } ?> >{!! $shop_det->stor_name!!}</option>
					@endforeach
