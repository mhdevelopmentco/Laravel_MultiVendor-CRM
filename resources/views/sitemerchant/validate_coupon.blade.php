...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin |Validate Coupon Code</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Validate Coupon Code</a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <form class="form-horizontal">
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-2">Code<span class="text-sub">*</span></label>
                    <div class="col-lg-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                     <button class="btn btn-warning btn-sm btn-grad"><a href="#" style="color:#fff">Update</a></button>
