...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin | Product details</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Deal details</a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
        	...
        	<div class="col-lg-11 panel_marg"style="padding-bottom:10px;">
               ...
               <?php echo date('M-d-Y h:m:s',strtotime($enddate)); ?>
                 ...
                 <?php echo $deals->deal_no_of_purchase; ?>
                    ...
                    <div class="col-lg-4">
                        No Deals Found(Waitnign For Table)
                    </div>
                </div>
                        </div>                       
                    </div>
