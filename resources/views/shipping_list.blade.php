...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |Shipping Delivery</title>
        ...
        <div id="div-1" class="accordion-body collapse in body">
           ...
           <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid"><div class="row"><div class="col-sm-6"><div id="dataTables-example_length" class="dataTables_length"><label>
                                    ...
                                    <thead>
                                        ...
                                        <th aria-label="Customers: activate to sort column ascending" style="width: 111px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">Products Name</th>
                                        ...
                                        <th aria-label="Amount(S/): activate to sort column ascending" style="width: 125px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">Email</th>
                      ...
                      <td class="center"><a data-target="<?php echo '#uiModal'.$i;?>" data-toggle="modal">view details</a></td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="border-bottom:none;text-align: center">
                                               ...
                                               <?php /* <div class="col-lg-4"><img src="assets/img/logo.png" alt="" style="width:100px;height:30px;"></div> */ ?>
                                      ...
                                      <b>Amount Paid :<?php echo "$".$totamt;?></b>
                                      <br>
                                      <span>((inclusive of all charges) )</span>
                                     <br> <br>
                                     <span>Order ID: <?php echo $shipping->order_id;?></span>
                                       <br>
					 <span>Order Date: <?php echo $shipping->order_date;?></span>
                                      </div>
                                          <div class="col-lg-6">
                                          <h4>Shipping Address</h4>
                                         
                                          <strong>Name:</strong><?php echo $shipping->ship_name;?><br/>
                                          <strong>Address:</strong><?php echo $shipping->ship_address1;?><br/><?php echo $shipping->ship_address2;?><br/>
                                          <strong>City:</strong><?php echo $shipping->ci_name; ?><br/>
                                          <strong>State:</strong><?php echo $shipping->ship_state;?><br/>
                                          <strong>Country:</strong><?php echo $shipping->co_name; ?><br/>
                                          <strong>Postal Code:</strong><?php echo $shipping->ship_postalcode;?><br/>
                                          <strong>Phone:</strong><?php echo $shipping->ship_phone;?><br/>
                                          </div>
                                    ...
                                    <td  width="13%" align="center">Color</td>&nbsp;
                                     ...
                                     <tr>	
                                    <td  width="13%" align="center"><?php echo $shipping->cf_name;?></td>&nbsp;
                               ...
                               <span>Shipment Value<b class="pull-right" style="margin-right:15px;"><?php echo '$ '.$subtotal ;?> </b></span><br><br>
                                        <span>Tax<b class="pull-right"style="margin-right:15px;"><?php echo $shipping->pro_inctax;?>%</b></span>
                                        <hr>
<?php $totamt= $subtotal + ($subtotal*($shipping->pro_inctax/100));?>
