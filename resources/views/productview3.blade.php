...
<?php foreach($product_details_by_id as $pro_details_by_id) { }
 ...
 ?>
    ...
    <li><a href="<?php echo url('products');?>">Productss</a> <span class="divider">/</span></li>
...
<br>
				...
				{!! Form :: open(array('url' => 'addtocart','class'=>'form-horizontal qtyFrm','enctype'=>'multipart/form-data')) !!}
				  <div class="control-group">
					<label class="control-label" style="font-size:18px;width:80px;"><strike class="srt" style="padding-left:0px;font-size:18px;">$ <?php echo  $pro_details_by_id->pro_price; ?></strike>  <span class="bold"></span></label><label class="control-label"><span><b>$<?php echo  $pro_details_by_id->pro_disprice; ?></b></span></label>
    ...
    <input type="hidden" name="rate_myproduct" id="tate" />
		...
		<?php } elseif (Session::has('customerid')=="") 
		{
			...
			?>
			<a href="#login" role="button" data-toggle="modal" style="padding-right:0; float:left;"><button class="wish-but" id="login_a_click"  value="Login">Add to Wishlist</button></a>
			<?php
		}
		?>
				<p style="float:left;">
    ...
    color: white;"><th colspan="2">Description</th></tr>
...
<table class="table table-bordered">
    ...
    color: white;"><th colspan="2">Store Details</th></tr>
    	...
    	<h4></h4>
    <div id="us3" style="width: 280px; height: 240px;margin-bottom:10px;"></div>
    </div></td>
<td><div class="span4">
<?php
...
<br>
                                    <?php } else {
			?>
		<h4>Reviews</h4><h4><span style="margin-top:-33px; float:right;"><a href="#login" role="button" data-toggle="modal" id="login_a_click"  value="Login">Write a Review Post</a></span></h4>
<?php 
if($product_count>=1)
{
