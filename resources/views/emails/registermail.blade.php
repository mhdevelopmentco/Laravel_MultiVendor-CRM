...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#fff;border-left: 3px solid #BF463D;border-right: 3px solid #BF463D;" class="hide">
										...
										<table width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;border-left:solid 1px #0870aa;border-right:solid 1px #0870aa;"> <tbody><img src="<?php echo url(); ?>/images/laravel-ecommerce.jpg" width="100%"><tr> <td align="left" valign="top" style="color:#2c2c2c;display:block;line-height:20px;font-weight:300;margin:0 auto;clear:both;border-bottom:1px solid #e6e6e6;background-color:#f9f9f9;padding:20px" bgcolor="#F9F9F9"> <p style="padding:0;margin:0;font-weight: bold;
    font-size: 20px;
    color: #000000;"> Hi {!! $cus_name!!}, </p><br>  <p style="padding:0;margin:0;color: #000000;
    line-height: 22px;
    font-size: 19px;
    margin-bottom: 15px !important;">  
 Your Register Account Was Created Successfully 
 <table width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;line-height:2.5;"> <tbody><tr> <td valign="top" align="center" style="background-color:#ffffff;display:block;margin:0 auto;clear:both;padding:5px 20px 0 20px" bgcolor="#fff"> <table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin:0"> <tbody><tr> <td colspan="4" align="center" valign="top" style="padding:0 0 17px 0">  
      ...
      <p style="padding:4px 5px;background-color: #fffdf6; border: 1px dashed#ff9800;;
    color: #191919;margin:10px 0 0 0;text-align:center;">  
   <span style="font-size:21px;color:#0266b5;font-weight:bold">Your Login Credentials Are: </span><br> <span class="aBn" data-term="goog_231825889" tabindex="0"><span style="font-size:16px;font-weight:bold" class="aQJ">User Name : {!! $first_name !!}<br>Password : {!! $password !!}</span></span>  
  </p>  
    ...
    text-align: center;
    border: #ff9800 solid 1px;padding:8px 0;text-decoration:none;border-radius:2px;display:block;color:#fff;font-size:13px" href="<?php echo url(); ?>/" align="center" target="_blank"> <span style="color:#ffffff;font-size:15px;font-weight:bold">Login Your Account</span> </a> </p> </td> </tr> </tbody></table>
