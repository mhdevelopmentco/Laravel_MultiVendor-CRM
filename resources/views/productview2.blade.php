...
<script src="<?php echo url(); ?>/themes/switch/theamswitcher.js" type="text/javascript" charset="utf-8"></script>
	...
	<a href="<?php echo url(''); ?>/themes/css/#" name="bootshop"><img src="<?php echo url(''); ?>/switch/images/clr/bootshop.png" alt="bootstrap business templates" class="active"></a>
	<a href="<?php echo url(''); ?>/themes/css/#" name="businessltd"><img src="<?php echo url(''); ?>/switch/images/clr/businessltd.png" alt="bootstrap business templates" class="active"></a>
	</div>
	<div class="themeName">Bootswatch Skins (11)</div>
	<div class="images style">
		<a href="<?php echo url(''); ?>/themes/css/#" name="amelia" title="Amelia"><img src="<?php echo url(''); ?>/switch/images/clr/amelia.png" alt="bootstrap business templates"></a>
		<a href="<?php echo url(''); ?>/themes/css/#" name="spruce" title="Spruce"><img src="<?php echo url(''); ?>/switch/images/clr/spruce.png" alt="bootstrap business templates" ></a>
		<a href="<?php echo url(''); ?>/themes/css/#" name="superhero" title="Superhero"><img src="<?php echo url(''); ?>/switch/images/clr/superhero.png" alt="bootstrap business templates"></a>
		<a href="<?php echo url(''); ?>/themes/css/#" name="cyborg"><img src="<?php echo url(''); ?>/switch/images/clr/cyborg.png" alt="bootstrap business templates"></a>
		<a href="<?php echo url(''); ?>/themes/css/#" name="cerulean"><img src="<?php echo url(''); ?>/switch/images/clr/cerulean.png" alt="bootstrap business templates"></a>
		<a href="<?php echo url(''); ?>/themes/css/#" name="journal"><img src="<?php echo url(''); ?>/switch/images/clr/journal.png" alt="bootstrap business templates"></a>
		<a href="<?php echo url(''); ?>/themes/css/#" name="readable"><img src="<?php echo url(''); ?>/switch/images/clr/readable.png" alt="bootstrap business templates"></a>	
		<a href="<?php echo url(''); ?>/themes/css/#" name="simplex"><img src="<?php echo url(''); ?>/switch/images/clr/simplex.png" alt="bootstrap business templates"></a>
		<a href="<?php echo url(''); ?>/themes/css/#" name="slate"><img src="<?php echo url(''); ?>/switch/images/clr/slate.png" alt="bootstrap business templates"></a>
		<a href="<?php echo url(''); ?>/themes/css/#" name="spacelab"><img src="<?php echo url(''); ?>/switch/images/clr/spacelab.png" alt="bootstrap business templates"></a>
		<a href="<?php echo url(''); ?>/themes/css/#" name="united"><img src="<?php echo url(''); ?>/switch/images/clr/united.png" alt="bootstrap business templates"></a>
