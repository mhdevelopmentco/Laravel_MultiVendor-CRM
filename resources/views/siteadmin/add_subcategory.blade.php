...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
             {!! Form::open(array('url'=>'add_sub_category_submit','class'=>'form-horizontal')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input id="catg_name" placeholder="" name="catg_name" class="form-control" value="{!!$add_sub_catg_det->smc_name!!}" type="text">                 <input type="hidden" id="catg_id" name="catg_id" value="{!!$add_sub_catg_det->smc_id!!}" />
                         <input type="hidden" id="main_catg_id" name="main_catg_id" value="{!!$add_sub_catg_det->smc_mc_id!!}" />
                    </div>
                </div>
