...
?>
        ...
        <div id="div-1" class="accordion-body collapse in body">
               {!! Form::open(array('url'=>'edit_product_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
 ...
 <div class="form-group">
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                    ...
                    <div class="col-lg-8">
                                <input type="checkbox" name="inctax" <?php if($inctax==1) { ?> checked="checked" <?php } ?> value="1">( Including tax amount )  
                    </div>
                </div>
				  <div class="form-group">
...
<div class="form-group">
	 <label for="text2" class="control-label col-lg-2">Product Size<span class="text-sub">*</span></label>
        ...
        <label>More custom sizes  <a href="http://demo.uniecommerce.com/demoadmin/admin/manage-sizes.html"> ADD</a></label>
                    </div>
                </div>
...
<div class="form-group" id="quantitydiv" <?php if($sizecount>0){ ?> style="display:block;" <?php }else { ?> style="display:none;" <?php } ?>>
...
$colorcode="";
 ?>
	...
	<?php 
		...
		$colorname=$existingcolor1->cf_name.",".$colorname;
		$colorcode=$existingcolor1->cf_code.",".$colorcode;
	?>
	@endforeach
...
<div class="form-group">
	 <label for="text2" class="control-label col-lg-2">Add Color Field<span class="text-sub">*</span></label>
                   ...
                   <div class="col-lg-8">  <input type="radio" name="productcolor" onClick="setVisibility1('sub3', 'none');" value="1" 
<?php if(!$colorcount>0){?>checked<?php } ?>> <label class="sample">No                  </label>
					<input type="radio" name="productcolor" onClick="setVisibility1('sub3', 'inline');" value="2" <?php if($colorcount>0){?>checked<?php } ?>><label class="sample">Yes</label>
						<label class="sample"></label>
                    </div>
                </div>
			 ...
			 @foreach ($productcolor as $color) 
           		 <option  value="<?php echo $color->cf_id;?>">{!!$color->cf_name!!}</option>
          		 @endforeach
      			    </select>
...
<?php $bordercolor="border:5px solid".$colorcodearray[$i];?>
			<span style="width:220px;padding:10px;<?php echo $bordercolor;?>";margin:0px;"><?php echo $colornamearray[$i];?></span>
		   ...
		   $.ajax( {
				  ...
				  success: function(responseText){  
				   ...
				   { 	 
					...
					$('#showcolor').append('<span style="width:220px;padding:10px;border:5px solid '+get_result[2]+';margin:0px;">'+get_result[0]+"</span>&nbsp;&nbsp;");			
