...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |Deals Success Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a>Deals Success Orders</a></li>
                            </ul>
                    </div>
                </div>
				<center>
		 <form  action="{!!action('TransactionController@deals_success_orders')!!}" method="POST">
			...
			foreach($successrep as $row) {
				...
				/*	if($allorders_list->order_paytype==1)
					...
					<tr class="gradeA odd">
                                            ...
                                            <td class="center     "><?php echo $row->order_amt;?></td>
                                            <td class="center     "><?php echo $row->order_tax;?></td>
