...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary Admin | Ads Add</title>
		...
		@endif
              {!! Form::open(array('url'=>'add_ad_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input id="text1" placeholder="" class="form-control" type="text" name="adtitle" value="{!! Input::old('adtitle') !!}">
                    </div>
                </div>
           ...
           <option value="0">select position</option>
            <option value="1">Middle Page</option>
		  </select>
                    </div>
                </div>
            ...
            <option value="1">Home</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                           <input id="text1" placeholder="" class="form-control" type="text" name="redirecturl" value="{!! Input::old('redirecturl') !!}">
                    </div>
                </div>
