...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |   Sold Products                   </title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >  Sold Products                    </a></li>
                            </ul>
                    </div>
                </div>
				<center>
		 <form  action="{!!action('ProductController@sold_product')!!}" method="POST">
			...
			if($product_list->pro_no_of_purchase>=$product_list->pro_qty)
			{
				  ...
				  $product_get_img = explode("/**/",$product_list->pro_Img);?>
						 ...
						 <td class="center  "><?php echo $product_list->pro_price; ?></td>
                             ...
                             <td class="center  "><a href="<?php echo url('product_details')."/".$product_list->pro_id; ?>">View</a>&nbsp;|&nbsp;<a href="<?php echo url('edit_product')."/".$product_list->pro_id; ?>">Edit</a></td>
                                        </tr>
									<?php $i++;
									}
							else
