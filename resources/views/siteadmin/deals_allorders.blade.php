...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |Deals All Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >Deals All Orders</a></li>
                            </ul>
                    </div>
                </div>
				<center>
		 <form  action="{!!action('TransactionController@deals_all_orders')!!}" method="POST">
