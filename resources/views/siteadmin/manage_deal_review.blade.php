                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >  Manage Deal Reviews                   </a></li>
                            </ul>
                    </div>
                </div>
        ...
        <div id="div-1" class="accordion-body collapse in body">
           <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="dataTables-example_length"><label>
                                    ...
                                    <thead>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 76px;" aria-label="Store Name: activate to sort column ascending">Review Title</th>
...
<?php $i = 1 ;
				...
				foreach($get_deal_review as $row) { 
                                    ...
                                    <tr class="gradeA odd">
                                            ...
                                            <td class="  "><?php echo substr($row->deal_title,0,45); ?></td>
                                           ...
                                           <a href="<?php echo url('edit_deal_review/'.$row->comment_id); ?>" > <i class="icon icon-edit" style="margin-left:15px;"></i></a>
                                           <?php if($row->status == 0){?>
                                            <a href="<?php echo url('block_deal_review/'.$row->comment_id.'/1');?>"> <i style='margin-left:10px;' class='icon icon-ok icon-me'></i> </a>
                                            <?php } elseif($row->status == 1) { ?>
                                             <a href="<?php echo url('block_deal_review/'.$row->comment_id.'/0');?>" > <i style='margin-left:10px;' class='icon icon-ban-circle icon-me'></i> </a>
                                             <?php } ?>
                                             <a href="<?php echo url('delete_deal_review')."/".$row->comment_id; ?>" ><i class="icon icon-trash icon-1x" style="margin-left:14px;"></i></a> 
                                             <?php ?>
                                            </td>
