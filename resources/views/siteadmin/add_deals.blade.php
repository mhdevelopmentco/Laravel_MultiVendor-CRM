...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <?php if(isset($action) && $action == 'save') { $process = 'save'; $button = 'Add Deals'; $form_action = 'add_deals_submit'; } 
         ...
         {!! Form::open(array('url'=>'add_deals_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
                    ...
                    <div class="col-lg-8">
                       <select class="form-control" id="merchant" name="merchant"  onChange="select_store_name(this.value)" >
                         ...
                         <?php foreach($merchant_details as $merchant_induvidual_details) { ?>
                          <option value="<?php echo $merchant_induvidual_details->mer_id;  ?>"><?php echo $merchant_induvidual_details->mer_fname;  ?></option>
                         <?php } ?>
           		        </select>
                    </div>
                </div>
