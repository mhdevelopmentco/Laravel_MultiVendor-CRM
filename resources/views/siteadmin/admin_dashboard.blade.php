...
?>
            	<div class="col-lg-12">
                        <div style="text-align: center;">
                              ...
                              <a class="quick-btn1 active" href="<?php echo url('manage_product');?>">
                                <i class="icon-check icon-2x"></i>
                                <span>Active Products</span>
                                <span class="label label-danger"><?php echo $activeproductscnt - $sold_cnt;?></span>
                            </a>
							<a class="quick-btn1" href="<?php echo url('sold_product');?>">
                          ...
                          <?php /*    <a class="quick-btn1" href="<?php echo url('expired_auction');?>">
                           ...
                           <?php /*    <a class="quick-btn1" href="<?php echo url('auction_winners');?>">
							...
							<a class="quick-btn1" href="<?php echo url('manage_customer');?>">
                                <i class="icon-check icon-2x"></i>
                                <span>Customers</span>
                                <span class="label label-danger"><?php echo $customers;?></span>
                            </a>
                            <a class="quick-btn1" href="<?php echo url('manage_merchant');?>">
                                <i class="icon-check icon-2x"></i>
                                <span>Merchants</span>
                                <span class="label label-danger"><?php echo $merchantscnt;?></span>
                            </a>
                            <a class="quick-btn1" href="<?php echo url('manage_merchant');?>">
                                <i class="icon-check icon-2x"></i>
                                <span>Stores</span>
							...
							<a class="quick-btn1" href="<?php echo url('manage_enquiry');?>">
                                <i class="icon-check icon-2x"></i>
		   ...
		   <div class="demo-container" id="chart1" style="margin-top:20px; margin-left:20px; width:950px; height:470px;"></div>		
                ...
                <div class="row">
                    <div class="col-lg-12">
                         <div class="panel panel-default">
                            <div class="panel-heading">
                               Total Customer And Product Count
                            </div>
            ...
            <table width="30%" border="0">
                              <tbody><tr>
                                <td style="background:#4bb2c5"><label class="label label-active">Admin User</label></td>
                                <td style="background:#eaa228"><label class="label label-archive">Website User</label></td>
                                 <td style="background:#C5B47F"><label class="label label-archive">Facebook User</label></td>
    ...
    <!-- FOOTER -->
    <div id="footer">
        <p>&copy;  Living Lectionary &nbsp;2015 &nbsp;</p>
    </div>
    <!--END FOOTER -->
    <script>
