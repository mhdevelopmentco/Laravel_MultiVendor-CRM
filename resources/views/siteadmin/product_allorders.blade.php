...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |Products All Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >Products All Orders</a></li>
                            </ul>
                    </div>
                </div>
				<center>
...
foreach($allproductrep as $allorders_list) {
					...
					else if($allorders_list->order_status==4) 
					{
						$orderstatus="failed";
					}
				...
				/*	if($allorders_list->order_paytype==1)
					...
					<tr class="gradeA odd">
                                            ...
                                            <td class="center"><span class="colr3"><?php echo $orderstatus;?></span></td>
                                            <td class="center"><?php echo $allorders_list->order_date;?></td>
                                            <td class="center"><span class="colr2"><?php echo $ordertype;?></span></td>
