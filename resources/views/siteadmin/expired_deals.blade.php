                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >Expired Deals</a></li>
                            </ul>
                    </div>
                </div>
				<center>
		 <form  action="{!!action('DealsController@expired_deals')!!}" method="POST">
...
if(isset($_POST['submit']))
			...
			foreach($exdeals_rep as $deal_list) { 
                                    ...
                                    <tr class="gradeA odd">
                                            ...
                                            <td class="  "><?php echo substr($deal_list->deal_title,0,45); ?></td>
                                            ...
                                            <td class="center  "><a href="<?php echo url('deal_details')."/".$deal_list->deal_id; ?>">View</a>&nbsp;|&nbsp;<a href="<?php echo url('edit_deals')."/".$deal_list->deal_id; ?>">Edit</a></td>
                                        </tr>
<?php $i++; } 	
			}
else
