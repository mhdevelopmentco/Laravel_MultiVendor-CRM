...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary | Deals Dashboard</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >Auction</a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>Auction Dashboard</h5>
            	...
            	<div class="row ">
                 ...
                 <button class="btn btn-success btn-sm btn-grad"><a style="color:#fff" href="<?php echo url('auction_cod');?>">See All Transaction</a></button>
                </div>
                </div>
        ...
        <div class="row">
                <div class="col-lg-6" style="padding:30px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Total Auctions Count</strong> 
                        ...
                        <div class="panel-body">
                           ...
                           <table width="30%" border="0">
                              <tr>
                                <td style="background:#4bb2c5"><label class="label label-active">Active Auction</label></td>
                                <td style="background:#eaa228"><label class="label label-archive">Archive Auction</label></td>
                           ...
                           <table width="30%" border="0">
                              <tr>
                                <td><label class="label label-active">Active Auctions</label></td>
                                <td><label class="label label-archive">Archive Auctions</label></td>
                ...
                <div class="col-lg-5 " style="padding-top:30px"> 
                    <div class="panel panel-default">
                        <div class="panel-heading">	
                            <strong>MARKET RESPONSE RATE</strong>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Total Auctions Count</td>
                                            <td><?php echo $tot_auc=  $active_count+$archievd_count; ?></td>
                                            
                                        </tr>
                                        <tr>
                                            <td colspan="2"><div class="progress progress-striped active">
		<div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" <?php echo 'style="width:'.$tot_auc.'%"'; ?>;> 
		...
		<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" <?php echo 'style="width:'.$active_count.'%"'; ?>;> 
		  <span class="sr-only">60% Complete</span>
                                        ...
                                        <tr>
                                            <td>Archieved Auctions Count</td>
                                            <td><?php echo $archievd_count; ?></td>
		...
		<div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"  <?php echo 'style="width:'.$archievd_count.'%"'; ?>;>
		  <span class="sr-only">40% Complete (success)</span>
                ...
                <div class="col-lg-5"  style="padding-left:12px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Auctions Transaction Details</strong>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Total Bidding Amt</td>
                                            <td>$ <?php echo $bidding_amt;  ?></td>
                                           
                                            
                                        </tr>
                                        <tr>
                                            <td>Total Bidding Winners</td>
                                            <td><?php echo $bidding_winner; ?></td>
                         ...
                         <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                              <ul class="nav nav-pills">
                                <li class="active"><a ata-toggle="tab">Last One Year Transaction</a>
                                </li>
                              </ul>
   ...
   {!! $adminfooter !!}
	...
	plot6 = $.jqplot('chart6', [[<?php echo $active_count; ?>,<?php echo $archievd_count; ?>]], {seriesDefaults:{renderer:$.jqplot.PieRenderer!!});
		});
	</script>
