                ...
                <tr>
                  ...
                  <td class="text-center">{!!$subs_list->email!!}</td>
                   ...
                   <?php if($subs_list->status == 1)  {
										  echo "<a href='".url('edit_newsletter_subscriber_status/'.$subs_list->id.'/0')."' > <i class='icon icon-ok icon-2x '></i> </a>";
								  } else  {
										   echo "<a href='".url('edit_newsletter_subscriber_status/'.$subs_list->id.'/1')."' > <i class='icon icon-ban-circle icon-2x icon-me'></i> </a>";
									  }
                   
                   
                  ?></td>
				    <td class="text-center"><a href="{!! url('delete_newsletter_subscriber').'/'.$subs_list->id!!}"><i class="icon icon-trash icon-2x"></i></a></td>
