...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary | Edit Products</title>
...
<div class="form-group">
                    ...
                    <div class="col-lg-8" id="img_upload">
                      ...
                      <input type="file" value="file" style="background:none;width:95px;border:none;"><span><img src="<?php echo url(''); ?>/assets/product/<?php echo $file_get_path[0]; ?>" height="65" width="50" > </span>                        </div>                   
                     <?php 
                     ...
                     <input type='file' name='file_more<?php echo $j; ?>' style="background:none;width:95px;border:none;" /> <img src="<?php echo url(''); ?>/assets/product/<?php echo $file_get_path[$j+1]; ?>" height="65" width="50" ></div>
					 <?php } ?>
                       <div id="divTxt"></div>  
...
if(merchant.val() == 0)
		...
		$('#error_msg').html('');
			...
			<?php /*?>var fileExtension = ['jpeg', 'jpg', 'png', 'gif', 'bmp'];
      	if(file.val() == "")
 		{
 		file.focus();
