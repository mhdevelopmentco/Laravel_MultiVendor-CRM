...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary | Logo Settings</title>
...
<div class="col-lg-12">
 ...
 {!! Form::open(array('url'=>'add_logo_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
          ...
          <?php foreach($logodetails as $logo){
				}
				$imgpath="assets/logo/".$logo->imgs_name;
		 ?>

                <div class="form-group">
                    <label for="text1" class="control-label col-lg-3">Current Logo<span class="text-sub">*</span></label>
