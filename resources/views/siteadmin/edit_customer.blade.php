...
?>
		...
		<input type="hidden" name="customer_edit_id" value="<?php echo $customer->cus_id; ?>" />
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="" name="customer_first_name"  value="<?php echo $customer->cus_name;?>">
                    </div>
                </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder=""    name="customer_Email" value="<?php echo $customer->cus_email;?>">
                    </div>
                </div>
                        </div>
						 <div class="panel-body">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="" id="customer_phone"  value="<?php echo $customer->cus_phone;?>"  name="customer_phone">
                    </div>
                </div>
                        </div>
						 <div class="panel-body">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder=""   value="<?php echo $customer->cus_address1;?>"  name="customer_address1">
                    </div>
                </div>
                        </div>
						 <div class="panel-body">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder=""  value="<?php echo $customer->cus_address2;?>"  name="customer_address2">
                    </div>
                </div>
                        </div>
						 <div class="panel-body">
                    ...
                    <div class="col-lg-4">
          <select class="form-control" name="select_customer_country" id="select_customer_country" onChange="select_city_ajax(this.value)" >
                        <option value="0">-- Select --</option>
                          <?php foreach($countryresult as $countrydetails){ ?>
          <option value="<?php echo $countrydetails->co_id; ?>" <?php if($countrydetails->co_id == $customer->cus_country) { ?> selected <?php } ?> ><?php echo $countrydetails->co_name; ?></option>
   <?php } ?>
       					 </select>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4">
                        <select class="form-control" id="select_customer_city" name="select_customer_city" >
                    ...
                    <div class="col-lg-8">
                     ...
                     <a href="<?php echo url('manage_customer');?>" class="btn btn-default btn-sm btn-grad" style="color:#000">Cancel</a>
...
$( document ).ready(function() {
	...
	var passData = 'city_id=<?php echo $customer->cus_city; ?>';
		   $.ajax( {
			      type: 'get',
				  data: passData,
				  url: '<?php echo url('customer_edit_getcity'); ?>',
				  success: function(responseText){  
				   if(responseText)
				   { 
				   		// alert(responseText);
