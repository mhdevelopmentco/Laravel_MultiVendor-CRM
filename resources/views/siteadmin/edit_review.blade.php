...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary | Edit Review</title>
        ...
        @foreach ($result as $info) @endforeach
             {!! Form::open(array('url'=>'edit_review_submit','class'=>'form-horizontal')) !!}
                ...
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-5">Review Title :<span class="text-sub">*</span></label>

                    <div class="col-lg-8">
                        <input type="hidden" name="comment_id" value="{!! $info->comment_id !!}"?>
                        <input id="text1" placeholder="Title" class="form-control" type="text" name="review_title" value="{!! $info->title !!}" >
                    </div>
                </div>
                <div class="form-group">
                <label for="text1" class="control-label col-lg-2">Review Description :<span class="text-sub">*</span></label>
                        <div class="col-lg-11">
                            ...
                            <div class="">
                                ...
                                <div class="body collapse in">
                                    <form>
                                        <textarea id="wysihtml5" class="form-control" rows="10" name="review_comment" >{!! $info->comments !!}</textarea>

                                        <div class="form-actions">
                                            <br />
                                           <button class="btn btn-warning btn-sm btn-grad"><a  style="color:#fff">Submit</a></button>
                     <button class="btn btn-default btn-sm btn-grad" type="reset" ><a href="<?php echo url('manage_cms_page'); ?> " style="color:#000">Reset</a></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
