                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a>Products Hold Orders</a></li>
                            </ul>
                    </div>
                </div>
				<center>
		 <form  action="{!!action('TransactionController@product_hold_orders')!!}" method="POST">
        ...
        <div id="div-1" class="accordion-body collapse in body">
           ...
           <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="dataTables-example_length"><label>
			...
			if(isset($_POST['submit']))
			{
				...
				foreach($product_holdrep as $allorders_list) {
