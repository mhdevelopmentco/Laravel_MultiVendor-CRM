...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |Deals COD All Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Deals COD All Orders</a></li>
                            </ul>
                    </div>
                </div>
...
<div class="col-lg-12">
        ...
        <div id="div-1" class="accordion-body collapse in body">
           ...
           <div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="dataTables-example_length"><label>
					...
					<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 72px;" aria-label="Status: activate to sort column ascending">Transaction Type</th>
                    	<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 72px;" aria-label="Status: activate to sort column ascending">COD Status Action</th>
					</tr>
                                    </thead>
                                    <tbody>
                                   <?php $i = 1 ;
				...
				if(isset($_POST['submit']))
			{
				...
				foreach($codrep as $row) {
					...
					else if($row->cod_status==2) 
					{
						$orderstatus="completed";
					}
					else if($row->cod_status==3) 
					{
						$orderstatus="Hold";
					}
					else if($row->cod_status==4) 
					{
						$orderstatus="failed";
					}
					...
					<tr class="gradeA odd">
                                            ...
                                            <td class="     "><?php echo $row->deal_title;?></td>
                                            <td class="center     "><?php echo $row->cod_amt;?></td>
                                            <td class="center     "><?php echo $row->cod_tax;?></td>
                                            <td class="center     "><a href="#" class="colr3"><?php echo $orderstatus;?></a></td>
                                            <td class="center     "><?php echo $row->cod_date;?></td>
                                            <td class="center     "><a href="#" class="colr2"><?php echo $ordertype;?></a></td>
                                          <td class="center     ">
                  <select name="<?php  echo 'status'.$row->cod_id;?>" class="btn btn-default" onchange="update_order_cod(this.value,<?php echo $row->cod_id;?>)">
                                              <option value="1" <?php if($row->cod_status==1){?> selected <?php } ?>>success</option>
                                               <option value="2" <?php if($row->cod_status==2){?> selected <?php } ?>>complete</option>
                                                <option value="3" <?php if($row->cod_status==3){?> selected <?php } ?>>Hold</option>
                                                  <option value="4" <?php if($row->cod_status==4){?> selected <?php } ?>>failed</option>
                                          </select>    
                                              </td>
			...
			else
			{
					...
					else if($allorders_list->cod_status==2) 
					{
						$orderstatus="completed";
					}
					else if($allorders_list->cod_status==3) 
					{
						$orderstatus="Hold";
					}
					else if($allorders_list->cod_status==4) 
					{
						$orderstatus="failed";
					}
					...
					<tr class="gradeA odd">
                                            ...
                                            <td class="center     "><?php echo $allorders_list->cod_amt;?></td>
                                            <td class="center     "><?php echo $allorders_list->cod_tax;?></td>
                                            <td class="center     "><a href="#" class="colr3"><?php echo $orderstatus;?></a></td>
                                            <td class="center     "><?php echo $allorders_list->cod_date;?></td>
                                            <td class="center     "><a href="#" class="colr2"><?php echo $ordertype;?></a></td>
                                          <td class="center     ">
                  <select name="<?php  echo 'status'.$allorders_list->cod_id;?>" class="btn btn-default" onchange="update_order_cod(this.value,<?php echo $allorders_list->cod_id;?>)">
                                              <option value="1" <?php if($allorders_list->cod_status==1){?> selected <?php } ?>>success</option>
                                               <option value="2" <?php if($allorders_list->cod_status==2){?> selected <?php } ?>>complete</option>
                                                <option value="3" <?php if($allorders_list->cod_status==3){?> selected <?php } ?>>Hold</option>
                                                  <option value="4" <?php if($allorders_list->cod_status==4){?> selected <?php } ?>>failed</option>
                                          </select>    
                                              </td>
   ...
   {!!$adminfooter!!}
	...
	function update_order_cod(id,orderid)
	{
		 ...
		 var pathnametemp = window.location.origin;
			if(id==1)
			{
				 var  urlrefresh=pathnametemp+"/nexemerchant/dealscod_completed_orders";
			}
			else if(id==2)
			{
			...
			{
				 var  urlrefresh=pathnametemp+"/nexemerchant/dealscod_hold_orders";
			}
			else if(id==4)
			{
				 var  urlrefresh=pathnametemp+"/nexemerchant/dealscod_failed_orders";
