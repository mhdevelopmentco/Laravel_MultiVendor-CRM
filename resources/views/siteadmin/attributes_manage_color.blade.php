              ...
              <?php $i=1;?>
                ...
                <tr>
                  ...
                  <td class="text-center">{!! $color->co_code!!}</td>
				   ...
				   <td class="text-center"><a href="{!! url('edit_color').'/'.$color->co_id!!}"><i class="icon icon-edit icon-2x"></i></a></td>
				    <td class="text-center"><a href="{!! url('delete_color').'/'.$color->co_id!!}"><i class="icon icon-trash icon-2x"></i></a></td>
