              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php echo $i; ?></td>
				     <td class="text-center"><?php echo $info->spg_name; ?></td>
					  <td class="text-center"><?php echo $info->spg_order; ?></td>
				   <td class="text-center">
<a href="<?php echo url('edit_specification_group/'.$info->spg_id); ?>"><i class="icon icon-edit icon-2x"></i></a></td>
				   <td class="text-center">
                   <a href="<?php echo url('delete_specification_group/'.$info->spg_id); ?>"><i class="icon icon-trash icon-2x"></i></a></td>
