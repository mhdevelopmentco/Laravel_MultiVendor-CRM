...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
             {!! Form::open(array('url'=>'edit_secsub_category_submit','class'=>'form-horizontal')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input id="catg_name" placeholder="" name="catg_name" class="form-control" value="{!!$add_sub_catg_det->smc_name!!}" type="text">                 <input type="hidden" id="catg_id" name="catg_id" value="{!!$add_sub_catg_det->sb_id!!}" />
                         <input type="hidden" id="main_catg_id" name="main_catg_id" value="{!!$add_sub_catg_det->smc_id !!}" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input id="main_catg_name" placeholder="" name="main_catg_name" class="form-control" value="{!!$add_sub_catg_det->sb_name !!}" type="text" />
                    </div>
                </div>
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                     ...
                     <a href="<?php echo url('manage_sub_category');?>/{!!$add_sub_catg_det->smc_id !!}" class="btn btn-default btn-sm btn-grad" style="color:#000">Cancel</a>
