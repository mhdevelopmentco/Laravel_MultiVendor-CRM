           ...
           <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid"><div class="row"><div class="col-sm-6"><div id="dataTables-example_length" class="dataTables_length"><label>
                                    ...
                                    <thead>
                                       <tr role="row">
                                        ...
                                        <th aria-label=" Tax (S/): activate to sort column ascending" style="width: 119px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">Product Details</th>
								...
								<tr class="gradeA odd">
                                            ...
                                            <td class="       "><?php echo $cod->pro_title;?></td>
                                            <td class="       "><?php echo $cod->cus_name;?></td>
                                            <td class="center"><?php echo $cod->cus_email;?></td>
                                            <td class="center"><?php echo $cod->cod_date;?></td>
                                               <td class="center"><?php echo $cod->ship_address1;?></td>
...
<div  id="<?php echo 'uiModal'.$i?>" class="modal fade in" style="display:none;">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="border-bottom:none;">
                                                ...
                                                <div class="col-lg-4"><img src="assets/logo/logo.png" alt="" style="width:100px;height:30px;"></div>
 ...
 <span>Order Date: <?php echo $coddetails->cod_date;?></span>
                                          ...
                                          <br>
                                          <strong><?php echo $coddetails->ship_address1;?></strong>
                                          
                                          <strong>Phone:<?php echo $coddetails->ship_phone;?></strong>
                                          </div>
                                    ...
                                    <div class="col-lg-6"></div>
                                     <div class="col-lg-6">
                               <span>Shipment Value<b class="pull-right" style="margin-right:15px;"><?php echo $subtotal ;?> </b></span><br>
                                        <span>Tax<b class="pull-right"style="margin-right:15px;"><?php echo $coddetails->cod_tax;?></b></span>
                                        <hr>
