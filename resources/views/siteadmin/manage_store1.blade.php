                                  ...
                                  //print_r($store_return);exit();
									 ...
									 ?>
										<tr class="gradeA odd">
                                            ...
                                            <?php
											//echo $store_is_or_not_in_deals[$store_details->stor_id].$store_is_or_not_in_product[$store_details->stor_id].$store_is_or_not_in_auction[$store_details->stor_id];exit();
                                            //echo $store_details->stor_id;exit();
											if($store_is_or_not_in_deals[$store_details->stor_id] == 0 && $store_is_or_not_in_product[$store_details->stor_id] == 0 && $store_is_or_not_in_auction[$store_details->stor_id] == 0 )
											{ 
											?> 
