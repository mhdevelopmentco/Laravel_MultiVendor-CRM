 ...
 <div class="row">
    ...
    <div class="col-lg-11 panel_marg">
    	...
    	<table class="table table-bordered">
              <thead>
                <tr>
				  ...
				  <th style="text-align:center;">Main Category Name</th>
				   <th style="text-align:center;">Add SecSub Category</th>
				    <th style="text-align:center;">Manage SecSub Category</th>
             ...
             <td class="text-center"><?php if($secsubcatg_count_list[$maincatg->sb_id]!=0) { ?><a href="{!! url('manage_secsubmain_category').'/'.$maincatg->sb_id!!}"><i class="icon-shopping-cart"></i><span style="color:#2574c4;padding-left:5px;">({!!$secsubcatg_count_list[$maincatg->sb_id]!!}) Categories </span></a><?php }else{?> <i class="icon-shopping-cart"></i><span style="color:#2574c4;padding-left:5px;">({!!$secsubcatg_count_list[$maincatg->sb_id]!!}) Categories </span><?php } ?></td>
				     <td class="text-center"><a href="{!! url('edit_secsub_main_category').'/'.$maincatg->sb_id!!}"><i class="icon icon-edit icon-2x"></i></a></td>
				   <td class="text-center"><?php if($maincatg->sb_status == 1){ ?><a href="{!! url('status_sub_category_submit').'/'.$maincatg->sb_id.'/'.$maincatg->sb_smc_id.'/'.'0'!!}"><i class="icon icon-ok icon-2x"></i></a> <?php } else { ?> <a href="{!! url('status_sub_category_submit').'/'.$maincatg->sb_id.'/'.$maincatg->sb_smc_id.'/'.'1'!!}"> <i class="icon icon-ban-circle icon-2x icon-me"></i></a> <?php } ?></td>
