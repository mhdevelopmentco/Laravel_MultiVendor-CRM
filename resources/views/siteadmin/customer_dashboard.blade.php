...
<div class="col-lg-12">
	...
	<div class="row ">
                        ...
                        <div class="panel-body">
                           <div id="chart6" style="margin-top:20px; margin-left:20px; width:450px; height:450px;"></div>
                            <table width="30%" border="0">
                              <tr>
                                <td style="background:#4bb2c5"><label class="label label-active">Facebook</label></td>
                                <td style="background:#eaa228"><label class="label label-archive">Website</label></td>
                                <td style="background:#c5b47f"><label class="label label-archive">Admin</label></td>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Website Customers </td>
                                            <td><?php echo  $website_users;?></td>
		...
		<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" <?php echo 'style="width:'.$admin_user.'%"'; ?>;> 
		  <span class="sr-only">60% Complete</span>
                                        ...
                                        <tr>
                                            <td>Facebook Customers</td>
                                            <td><?php echo $fb_users; ?></td>
 ...
 <tr>
                                            ...
                                            <td><?php echo $totalcus=$website_users+$admin_user+$fb_users; ?></td>
		...
		<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" <?php echo 'style="width:'.$totalcus.'%"'; ?>;> 
		  <span class="sr-only">60% Complete</span>
                ...
                <div class="col-lg-5"  style="padding-left:12px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Customer Login Date Details</strong>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
					 ...
					 <tr>
                                            <td>Today</td>
                                            <td><?php echo $logintoday[0]->count; ?></td>
                                           
                                            
                                        </tr>
                                        <tr>
                                            <td>Last 7 days</td>
                                            <td><?php echo $login7days[0]->count;?></td>
                                           
                                            
                                        </tr>
                                        <tr>
                                            <td>Last 30 days</td>
                                            <td><?php echo $login30days[0]->count;?></td>
                                           
                                            
                                        </tr>
                                        <tr>
                                            <td>Last 12 months</td>
                                            <td><?php echo $login12mnth[0]->count;?></td>
                         ...
                         <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                              <ul class="nav nav-pills">
                                <li class="active"><a href="#home-pills" data-toggle="tab">Last One Year Website Customers</a>
                                </li>
                              </ul>
   ...
   {!! $adminfooter !!}
	...
	plot6 = $.jqplot('chart6', [[<?php echo $fb_users; ?>,<?php echo $website_users; ?>,<?php echo $admin_user ?>]], {seriesDefaults:{renderer:$.jqplot.PieRenderer } });
		});
	</script>
