...
<div class="col-lg-12">
            ...
            <h5>Deals Dashboard</h5>
            	...
            	<div class="row ">
                 ...
                 <a style="color:#fff" href="<?php echo url(); ?>" class="btn btn-warning btn-sm btn-grad" target="_blank" >Go to Live</a>
                  ...
                  <a style="color:#fff" href="<?php echo url(); ?>/deals_all_orders" class="btn btn-warning btn-sm btn-grad" target="_blank" >See All Transaction</a>
                        ...
                        <div class="panel-body">
                           <div id="chart6" style="margin-top:20px; margin-left:20px; width:450px; height:450px;"></div>
                            <table width="30%" border="0">
                              <tr>
                                <td style="background:#4bb2c5"><label class="label label-active">Active Deals</label></td>
                                <td style="background:#eaa228"><label class="label label-archive">Archive Deals</label></td>
                                ...
                                <table class="" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $tot_dea=  $active_count+$archievd_count; ?></td>
                                            
                                        </tr>
                                        <tr>
                                            <td colspan="2"><div class="progress progress-striped active">
		<div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" <?php echo 'style="width:'.$tot_dea.'%"'; ?>;> 
		  <span class="sr-only">60% Complete</span>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
												$active_count=  $tot_dea-$archievd_count;
											    echo $active_count;
											 ?></td>
                         ...
                         <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                              <ul class="nav nav-pills">
                                <li class="active"><a data-toggle="tab">Last One Year Transaction</a>
                                </li>
                              </ul>
   ...
   {!! $adminfooter !!}
	...
	plot6 = $.jqplot('chart6', [[<?php echo $archievd_count; ?>,<?php echo $active_count; ?> ]], {seriesDefaults:{renderer:$.jqplot.PieRenderer } });
		});
	</script>
