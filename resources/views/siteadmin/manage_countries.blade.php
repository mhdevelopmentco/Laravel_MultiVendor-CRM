...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |Manage Countries</title>
...
<div class="col-lg-12">
 ...
 <div class="row">
    ...
    @if (Session::has('updated_result'))
		...
		<td class="text-center"><a href="<?php echo url('edit_country/'.$info->co_id); ?>"><i class="icon icon-edit icon-2x"></i></a></td>



  		<td class="text-center"><?php if($info->co_status== 0){ ?><a href="{!! url('status_country_submit').'/'.$info->co_id.'/'.'1'!!}"><i class="icon icon-ban-circle icon-2x"></i>
                  </a> <?php } else { ?> <a href="{!! url('status_country_submit').'/'.$info->co_id.'/'.'0'!!}">
                   <i class="icon icon-ban-circle icon-2x icon-me"></i></a> <?php } ?></td>
		 <td class="text-center"><a href="<?php echo url('delete_country/'.$info->co_id); ?>"><i class="icon icon-trash icon-2x"></i></a></td>
