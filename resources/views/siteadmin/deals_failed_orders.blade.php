...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |Deals Failed Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >Deals Failed Orders</a></li>
                            </ul>
                    </div>
                </div>
				
				<center>
		 <form  action="{!!action('TransactionController@deals_failed_orders')!!}" method="POST">
