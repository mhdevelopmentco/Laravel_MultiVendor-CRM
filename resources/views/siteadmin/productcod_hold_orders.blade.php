...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |Products Hold Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >COD Hold Orders</a></li>
                            </ul>
                    </div>
                </div>
				
				<center>
		 <form  action="{!!action('TransactionController@cod_hold_orders')!!}" method="POST">
	...
	if(isset($_POST['submit']))
			{
				...
				foreach($productcod_holdrep as $allorders_list) {
