...
?>
            	...
            	<div class="row ">
                 ...
                 <a style="color:#fff" href="<?php echo url(); ?>" class="btn btn-success btn-sm btn-grad" target="_blank" >Go to Live</a>
                 
                    <a style="color:#fff" href="<?php echo url(); ?>/product_all_orders" class="btn btn-warning btn-sm btn-grad" target="_blank" >See All Transaction</a>
 		 </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <table width="30%" border="0">
                              <tbody><tr>
                                <td style="background:#4bb2c5"><label class="label label-active">Active products</label></td>
                                <td style="background:#eaa228"><label class="label label-archive">Sold products</label></td>
		...
		<div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" <?php echo 'style="width:'.$tot_pro.'%"'; ?>;> 
		  <span class="sr-only">60% Complete</span>
                                        ...
                                        <tr>
                                            <td>Active Products Count</td>
                                            <td><?php
												$active_count=  $tot_pro-$sold_cnt;
										    	echo $active_count; 
		...
		<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" <?php echo 'style="width:'.$active_count.'%"'; ?>;> 
		  <span class="sr-only">60% Complete</span>
                                        ...
                                        <tr>
                                            <td>Sold Products Count</td>
                                            <td><?php echo $sold_cnt; ?></td>
                                            
                                        </tr>
                                         <tr>
                                             <td colspan="2"><div class="progress progress-striped active">
		<div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"  <?php echo 'style="width:'.$active_count.'%"'; ?>;>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                      <tr>
                                            <td>Today</td>
                                            <td><?php echo $producttdy[0]->count;?></td>
                                            <td><?php if($producttdy[0]->amt){echo "$".$producttdy[0]->amt;}else{echo "-";}?></td>
                                            
                                        </tr>
                                        <tr>
                                            <td>Last 7 days</td>
                                            <td><?php echo $product7days[0]->count;?></td>
                                            <td><?php if($product7days[0]->amt){echo "$".$product7days[0]->amt;}else{echo "-";}?></td>
                         ...
                         <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                              <ul class="nav nav-pills">
                                <li class="active"><a >Last One Year Transaction</a>
                                </li>
                              </ul>
   ...
   {!! $adminfooter !!}
	...
	plot6 = $.jqplot('chart6', [[<?php echo $active_count; ?>,<?php echo $sold_cnt; ?> ]], {seriesDefaults:{renderer:$.jqplot.PieRenderer } });
		});
	</script>
