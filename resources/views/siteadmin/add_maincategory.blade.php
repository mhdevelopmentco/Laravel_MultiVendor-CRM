        ...
        <div id="div-1" class="accordion-body collapse in body">
             {!! Form::open(array('url'=>'add_main_category_submit','class'=>'form-horizontal')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input id="catg_name" placeholder="" name="catg_name" class="form-control" value="{!!$add_main_catg_det->mc_name!!}" type="text">                 <input type="hidden" id="catg_id" name="catg_id" value="{!!$add_main_catg_det->mc_id!!}" />
                    </div>
                </div>
