...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |Manage Ads</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >Manage Ads | VirtualPlaza</a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
...
?>
		...
		else if($info->ad_position=="1")
		{
			$positionname="Header right";
		}
		else if($info->ad_position=="2")
		{
			$positionname="Left side bar";
		}
		...
		if($info->ad_pages=="0")
		{
			$pagename="select any page";
		}
		else if($info->ad_pages=="1")
		{
			$pagename="Home";
		}
		else if($info->ad_pages=="2")
		{
			$pagename="Deals";
		}
		else if($info->ad_pages=="3")
		{
			$pagename="Product";
		}
		else if($info->ad_pages=="4")
		{
			$pagename="Auction";
		}
...
?>
                ...
                <tr>
				  ...
				  <td class="text-center"><a href="{!! url('edit_ad').'/'.$info->ad_id!!}"><i class="icon icon-edit icon-2x"></i></a></td>
                   	
				    <td class="text-center"><?php if($info->ad_status==0){ ?><a href="{!! url('status_ad_submit').'/'.$info->ad_id.'/'.'1'!!}"><i class="icon icon-ok icon-2x"></i>
                  </a> <?php } else { ?> <a href="{!! url('status_ad_submit').'/'.$info->ad_id.'/'.'0'!!}">
                   <i class="icon icon-ban-circle icon-2x icon-me"></i></a> <?php } ?></td>
					 <td class="text-center"><a href="{!! url('delete_ad').'/'.$info->ad_id!!}"><i class="icon icon-trash icon-2x"></i></a></td>
                </tr>
