...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |Deals COD Completed Orders</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">Deals COD Completed Orders</a></li>
                            </ul>
                    </div>
                </div>
				
				<center>
		 <form  action="{!!action('TransactionController@dealscod_completed_orders')!!}" method="POST">
...
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>Deals COD Completed Orders</h5>
