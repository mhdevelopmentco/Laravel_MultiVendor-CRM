...
<head>
    <meta charset="UTF-8" />
    <title>Living Lectionary |COD Failed Orders</title>
...
{!!$adminleftmenus!!}
        ...
        <div id="content">
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >COD Failed Orders</a></li>
                            </ul>
                    </div>
                </div>
				...
				<center>
		 <form  action="{!!action('TransactionController@cod_failed_orders')!!}" method="POST">
	...
	if(isset($_POST['submit']))
			{
				...
				foreach($productcod_failedrep as $allorders_list) {
