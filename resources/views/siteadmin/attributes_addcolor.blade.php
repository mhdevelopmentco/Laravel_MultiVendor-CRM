...
<div class="col-lg-12">
    ...
    {!! Form::open(array('url'=>'add_color_submit','class'=>'form-horizontal col-lg-8')) !!}
 <div id="ntc" class="col-lg-9">
    ...
    <script type="text/javascript" src="assets/plugins/farbtastic.js"></script> 
    
    <script type="text/javascript" src="assets/plugins/ntc.js"></script> 
    
     <script type="text/javascript" src="assets/plugins/ntc_main.js"></script> 
