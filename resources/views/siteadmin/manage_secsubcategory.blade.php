    	...
    	<table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th  class="text-center">SecSub Category Name</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">{!! $maincatg->sb_name!!}</td>
				   ...
				   <td class="text-center"><?php if($maincatg->ssb_status == 1){ ?><a href="{!! url('status_secsub_category_submit').'/'.$maincatg->ssb_id.'/'.$maincatg->ssb_sb_id .'/'.'0'!!}"><i class="icon icon-ok icon-2x"></i></a> <?php } else { ?> <a href="{!! url('status_secsub_category_submit').'/'.$maincatg->ssb_id.'/'.$maincatg->ssb_sb_id .'/'.'1'!!}"> <i class="icon icon-ban-circle icon-2x icon-me"></i></a> <?php } ?></td>
				    <td class="text-center"><a href="{!! url('delete_secsub_category').'/'.$maincatg->ssb_id.'/'.$maincatg->ssb_sb_id!!}"><i class="icon icon-trash icon-2x"></i></a></td>
