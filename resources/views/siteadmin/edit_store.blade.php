                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >Add Store Account</a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
        ...
        <div class="row">
        	<div class="col-lg-11 panel_marg"style="padding-bottom:10px;">
                    ...
                    <div class="col-lg-8">
                     ...
                     <a href="<?php echo url('manage_store');?>" class="btn btn-default btn-sm btn-grad" style="color:#000">Cancel</a>
