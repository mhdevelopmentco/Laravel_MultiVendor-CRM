...
<!-- Sidebar end=============================================== -->
 ...
 {!! Form::open(array('url'=>'merchant_signup_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
            <div id="wizard">
                <h2>Introduction</h2>
                <section class="banner">
                <h4 style="padding:10px;background:#eee;">Create your store: Introduction</h4>
                    <p>
                            Over the next few simple steps you will be shown how to create your own personal online store front which you will be able to use to sell your products or deals or auctions to thousands of people across the Middle East. By clicking the 'Accept' button below and proceeding to create an online store front on claydip you are agreeing to the Terms of Use, Privacy Policy and Marketplace Rules. You are also confirming that you wish to use this service, that you wish to list your products and/or services for sale on RocketBoxit and that these services are able to be provided by you proficiently and confidently as a professional in your chosen field, or that these products are of your own design or creation and have been made by you, that you own the rights of sale/re-sale and/or the rights of distribution.                            
                            </p>
                </section>
             ...
             <h4 style="padding:10px;background:#eee;">Create your store: Sign Up</h4>
               ...
               <div class="form-group controls-row" style="margin-top:10px; margin-bottom:10px">
                ...
                <div class="form-group controls-row" style="margin-top:10px; margin-bottom:10px">
                    <label class="control-label span2" for="text1"><span class="text-sub"></span></label>

                    <div class="col-lg-4">
                        <input id="pac-input" class="form-control span5" type="text" placeholder="Type your location here (Auto-complete)">
                ...
                <div class="form-group controls-row" style="margin-top:10px; margin-bottom:10px">
                    <label class="control-label span2" for="text1">Map Search Location <span class="text-sub">*</span><br><span  style="color:#999">(Drag Marker to get latitude & longitude )</span></label>
                ...
                <div class="form-group controls-row" style="margin-top:10px; margin-bottom:10px">
                    <label class="control-label span2" for="text1">Latitude<span class="text-sub">*</span></label>

                    <div class="col-lg-4">
                        <input type="text" class="form-control span5" placeholder="" id="latitude" name="latitude" readonly  value="{!! Input::old('latitude') !!}"  >
                    </div>
                </div>
                <div class="form-group controls-row" style="margin-top:10px; margin-bottom:10px">
                    <label class="control-label span2" for="text1">Longitude<span class="text-sub">*</span></label>

                    <div class="col-lg-4">
                        <input type="text" class="form-control span5" placeholder="" id="longtitude" name="longtitude" value="{!! Input::old('longtitude') !!}"  readonly >
                    </div>
                </div>
...
<!-- Placed at the end of the document so the pages load faster ============================================= -->
 ...
 <script src="<?php echo url(); ?>/themes/js/jquery-1.9.1.min.js"></script>
